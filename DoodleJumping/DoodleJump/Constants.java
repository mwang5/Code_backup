...
public static final int REBOUND_VELOCITY = -500; // initial jump velocity (UNITS: pixels/s^2)
public static final int TIMESTEP = 16; // timer delay (UNITS: ms)
...
public static final int DOODLE_WIDTH = 20; // doodle width (UNITS: pixels)
